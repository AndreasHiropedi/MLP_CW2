...
class ConvolutionalProcessingBlock_BatchNorm(nn.Module):
    
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_BatchNorm, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_BatchNorm(nn.Module):
    
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_BatchNorm, self).__init__()
...
class ConvolutionalProcessingBlock_BatchNorm_ResCon(nn.Module):
    
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_BatchNorm_ResCon, self).__init__()
