...
if __name__ == '__main__':
    ...
    elif args.block_type == 'convBatchNorm_block':
    ...
    elif args.block_type == 'convBatchNormResCon_block':
        processing_block_type = ConvolutionalProcessingBlock_BatchNorm_ResCon
        dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock_BatchNorm
    else:
